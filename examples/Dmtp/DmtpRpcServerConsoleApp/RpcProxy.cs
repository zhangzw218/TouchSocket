...
/// <exception cref="System.Exception">其他异常</exception>
[AsyncToSyncWarning]
void CallClientNotice(InvokeOption invokeOption = default);
///<summary>
///测试反向Rpc
///</summary>
/// <exception cref="System.TimeoutException">调用超时</exception>
...
/// <exception cref="System.Exception">其他异常</exception>
[AsyncToSyncWarning]
public void CallClientNotice(InvokeOption invokeOption = default)
{
if(this.Client==null)
{
throw new RpcException("IRpcClient为空，请先初始化或者进行赋值");
}
this.Client.Invoke("CallClientNotice",null,invokeOption, null);
...
/// <exception cref="System.Exception">其他异常</exception>
[AsyncToSyncWarning]
public static void CallClientNotice<TClient>(this TClient client,InvokeOption invokeOption = default) where TClient:
TouchSocket.Dmtp.Rpc.IDmtpRpcActor{
client.Invoke("CallClientNotice",null,invokeOption, null);
