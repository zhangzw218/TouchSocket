...
public static class PluginManagerExtension
{
    ...
    public static TPlugin Add<[DynamicallyAccessedMembers(AOT.PluginMemberType)] TPlugin>(this IPluginManager pluginManager, Func<IResolver, TPlugin> func) where TPlugin : class, IPlugin
    {
    ...
    public static TPlugin Add<[DynamicallyAccessedMembers(AOT.PluginMemberType)] TPlugin>(this IPluginManager pluginManager) where TPlugin : class, IPlugin
    {
    ...
    public static void Add<TSender, TEventArgs>(this IPluginManager pluginManager, [DynamicallyAccessedMembers(AOT.PluginMemberType)] Type interfaceType, Func<TSender, TEventArgs, Task> func) where TEventArgs : PluginEventArgs
    {
    ...
    /// <typeparam name="TEventArgs">事件参数的类型，必须继承自PluginEventArgs。</typeparam>
    public static void Add<TEventArgs>(this IPluginManager pluginManager, [DynamicallyAccessedMembers(AOT.PluginMemberType)] Type interfaceType, Func<TEventArgs, Task> func) where TEventArgs : PluginEventArgs
    {
    ...
    public static void Add(this IPluginManager pluginManager, [DynamicallyAccessedMembers(AOT.PluginMemberType)] Type interfaceType, Func<Task> func)
    {
    ...
    public static void Add<T>(this IPluginManager pluginManager, [DynamicallyAccessedMembers(AOT.PluginMemberType)] Type interfaceType, Action<T> action) where T : class
    {
    ...
    public static void Add(this IPluginManager pluginManager, [DynamicallyAccessedMembers(AOT.PluginMemberType)] Type interfaceType, Action action)
    {
    ...
    public static ValueTask<bool> RaiseAsync(this IPluginManager pluginManager, [DynamicallyAccessedMembers(AOT.PluginMemberType)] Type pluginType, object sender, PluginEventArgs e)
    {
