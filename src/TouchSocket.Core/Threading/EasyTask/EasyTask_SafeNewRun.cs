...
static partial class EasyTask
{
    ...
    public static async Task<Result> SafeNewRun(Func<Task> func)
    {
        if (func is null)
        {
    ...
    /// <returns>表示异步操作的任务。</returns>
    public static async Task<Result> SafeNewRun(Func<CancellationToken, Task> func, CancellationToken ct)
    {
        if (func is null)
        {
            return Result.FromFail(TouchSocketCoreResource.ArgumentIsNull.Format(nameof(func)));
    ...
    /// <param name="func">要运行的异步方法。</param>
    /// <returns>表示异步操作的任务。</returns>
    public static async Task<Result<TResult>> SafeNewRun<TResult>(Func<Task<TResult>> func)
    {
        if (func is null)
        {
    ...
    /// <param name="ct">取消令牌。</param>
    /// <returns>表示异步操作的任务。</returns>
    public static async Task<Result<TResult>> SafeNewRun<TResult>(Func<CancellationToken, Task<TResult>> func, CancellationToken ct)
    {
        if (func is null)
        {
            return new Result<TResult>(ResultCode.Failure, TouchSocketCoreResource.ArgumentIsNull.Format(nameof(func)));
    ...
    /// <returns>表示异步操作的任务。</returns>
    public static async Task<Result> SafeNewRun<T1>(Func<T1, Task> func, T1 status)
    {
        if (func is null)
        {
            return Result.FromFail(TouchSocketCoreResource.ArgumentIsNull.Format(nameof(func)));
    ...
    /// <param name="ct">取消令牌。</param>
    /// <returns>表示异步操作的任务。</returns>
    public static async Task<Result> SafeNewRun<T1>(Func<T1, CancellationToken, Task> func, T1 status, CancellationToken ct)
    {
        if (func is null)
        {
            return Result.FromFail(TouchSocketCoreResource.ArgumentIsNull.Format(nameof(func)));
    ...
    /// <param name="status">传递给方法的状态。</param>
    /// <returns>表示异步操作的任务。</returns>
    public static async Task<Result<TResult>> SafeNewRun<T1, TResult>(Func<T1, Task<TResult>> func, T1 status)
    {
        if (func is null)
        {
            return new Result<TResult>(ResultCode.Failure, TouchSocketCoreResource.ArgumentIsNull.Format(nameof(func)));
    ...
    /// <param name="ct">取消令牌。</param>
    /// <returns>表示异步操作的任务。</returns>
    public static async Task<Result<TResult>> SafeNewRun<T1, TResult>(Func<T1, CancellationToken, Task<TResult>> func, T1 status, CancellationToken ct)
    {
        if (func is null)
        {
            return new Result<TResult>(ResultCode.Failure, TouchSocketCoreResource.ArgumentIsNull.Format(nameof(func)));
    ...
    /// <returns>表示异步操作的任务。</returns>
    public static async Task<Result> SafeNewRun<T1, T2>(Func<T1, T2, Task> func, T1 status1, T2 status2)
    {
        if (func is null)
        {
            return Result.FromFail(TouchSocketCoreResource.ArgumentIsNull.Format(nameof(func)));
    ...
    /// <param name="ct">取消令牌。</param>
    /// <returns>表示异步操作的任务。</returns>
    public static async Task<Result> SafeNewRun<T1, T2>(Func<T1, T2, CancellationToken, Task> func, T1 status1, T2 status2, CancellationToken ct)
    {
        if (func is null)
        {
            return Result.FromFail(TouchSocketCoreResource.ArgumentIsNull.Format(nameof(func)));
    ...
    /// <param name="status2">传递给方法的第二个状态。</param>
    /// <returns>表示异步操作的任务。</returns>
    public static async Task<Result<TResult>> SafeNewRun<T1, T2, TResult>(Func<T1, T2, Task<TResult>> func, T1 status1, T2 status2)
    {
        if (func is null)
        {
            return new Result<TResult>(ResultCode.Failure, TouchSocketCoreResource.ArgumentIsNull.Format(nameof(func)));
    ...
    /// <param name="ct">取消令牌。</param>
    /// <returns>表示异步操作的任务。</returns>
    public static async Task<Result<TResult>> SafeNewRun<T1, T2, TResult>(Func<T1, T2, CancellationToken, Task<TResult>> func, T1 status1, T2 status2, CancellationToken ct)
    {
        if (func is null)
        {
            return new Result<TResult>(ResultCode.Failure, TouchSocketCoreResource.ArgumentIsNull.Format(nameof(func)));
