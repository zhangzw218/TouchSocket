...
/// </summary>
public interface ISerializationSelectorV4
{
    /// <summary>
    /// 反序列化字节块中的参数。
    /// </summary>
    ...
    object DeserializeParameter<TReader>(ref TReader reader, SerializationTypeV4 serializationType, Type parameterType) where TReader : IBytesReaderV4
    ...
    void SerializeParameter<TWriter>(ref TWriter wirter, SerializationTypeV4 serializationType, in object parameter) where TWriter : IBytesWriterV4
