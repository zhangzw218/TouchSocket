...
public static class HttpConfigExtensions
{
    ...
    /// <summary>
    /// HTTP 版本属性，默认为 <see cref="TouchV4Socket.Http.HttpVersion.Http1"/>。
    /// </summary>
    [GeneratorProperty(TargetType = typeof(TouchSocketConfig))]
    public static readonly DependencyProperty<TouchV4Socket.Http.HttpVersion> HttpVersionProperty = new DependencyProperty<TouchV4Socket.Http.HttpVersion>("HttpVersion", TouchV4Socket.Http.HttpVersion.Http1);
